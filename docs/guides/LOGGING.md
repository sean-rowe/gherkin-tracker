...
python3 agent_claude.py --project CareSync --max-tasks 10 --verbose --log-file logs/agent.log

# Run with log file only (no verbose console)
python3 agent_claude.py --project CareSync --max-tasks 10 --log-file logs/agent.log

# Multiple parallel agents with logging
python3 agent_claude.py --project CareSync --parallel 4 --verbose --log-file logs/agent.log
```
